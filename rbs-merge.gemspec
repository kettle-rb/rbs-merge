...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rbs/merge/version.rb", mod) }::Rbs::Merge::Version::VERSION
  else
    ...
    require "rbs/merge/version"
    Rbs::Merge::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  # RBS parsing and type signatures
  spec.add_dependency("rbs", ">= 3.0")                                  # ruby >= 3.0.0

  # Base AST merge functionality
  ...
  # The 'git' gem is optional; rbs-merge falls back to shelling out to `git` if it is not present.
